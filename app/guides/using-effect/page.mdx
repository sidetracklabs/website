...
const SidetrackService = SidetrackEffect.createSidetrackServiceTag<Queues>();

const sidetrackLayer = SidetrackEffect.makeLayer<Queues>({
  databaseOptions: {
...
<Callout type="warning" emoji="⚠️">
  If you use ESM, you can use the `sidetrack/effect` import. If the `sidetrack/effect` import doesn't work, you will need to use
