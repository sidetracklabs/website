...
There's currently only 1 options you can customize:
...
```
This job will fail on the first run, and move to retrying status since its currentAttempt (1) \<= 5. After 5 attempts, the job will transition to failed.
