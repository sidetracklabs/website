...
One huge advantage of being a database-backed job-queue library is that we can insert jobs transactionally! This means that if you are in the middle of a transaction and your transaction fails, you can roll back. The following is an example of how to insert a job transactionally with the sidetrack Prisma client wrapper:
