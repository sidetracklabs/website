...
We also love using [Effect-TS](https://effect.website/), and had to create internal wrappers around other libraries to make them work with Effect. We wanted to create a library that was built with Effect in mind, and that would allow us to use Effect.
